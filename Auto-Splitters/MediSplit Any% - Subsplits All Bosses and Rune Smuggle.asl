...
split {
    ...
    // The Hilltop Mausoleum with subsplits. Change the currSegName value to match your splits or subsplits.
    ...
    // Return to the Graveyard with subsplits. Change the currSegName value to match your splits or subsplits.
    ...
    // The Gallows Gauntlet with subsplits for Rune Smuggle. Change the currSegName value to match your splits or subsplits.
