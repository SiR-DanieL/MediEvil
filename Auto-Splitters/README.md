# MediSplit - MediEvil Auto Splitter and Auto Starter for Live Split
...
Due to the usage of `emu-help-v3`, it might also work on Duckstation and other emulators, but it was not tested with it.

## Using this Auto Splitter

1. Download the `emu-help-v3` library from this repository and paste the file into your `LiveSplit/Componets/` folder in your computer.
...
* [Emu-help Main Repository](https://github.com/Jujstme/emu-help-v3)
...
* NoobKillerRoof - For extensive testing
